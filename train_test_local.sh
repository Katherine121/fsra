...
dataset_path="../../../nfs3/wyx/processOrder/order"
class_path="../../../nfs3/wyx/processOrder/100/cluster_labels"
k=100
gpu_ids=0
num_worker=4
lr=0.01
...
python train.py --name $name --data_dir $data_dir --dataset_path $dataset_path --class_path $class_path --k $k \
--gpu_ids $gpu_ids --num_worker $num_worker --views $views --lr $lr \
